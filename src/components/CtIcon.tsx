...
function CtIcon({ icon }){
  ...
  switch (icon) {
    case 'copy':
      iconEle = (
        <svg className="inline w-6 h-6 text-gray-800 dark:text-white hover:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
